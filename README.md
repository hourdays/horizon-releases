...
pip install https://github.com/hourdays/horizon-releases/releases/download/v1.4.0/horizon-1.4.0-py3-none-any.whl
```
...
3. Create a `requirements.txt` pointing to the wheel:
   ```
   horizon-1.4.0-py3-none-any.whl
   ```
...
| Version | Date | Notes |
|---------|------|-------|
| v1.4.0 | 2024-12 | Account configuration persistence |
| v1.3.4 | 2024-12 | Multi-user support, UI improvements |
